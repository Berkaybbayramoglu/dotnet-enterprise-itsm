...
def fix_tooltip():
    ...
    start_str = "document.addEventListener('mouseover', (e) => {"
    if start_str in content:
        start_idx = content.find(start_str)
        # We need to find the matching closing bracket for this addEventListener.
        ...
        with open(path, "w") as f:
            f.write(content)
        print("Refactored tooltip successfully")
    else:
