    ...
    public partial class AddSlaAndNotifications : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectSequences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectSequences_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPausedMinutes = table.Column<int>(type: "integer", nullable: false),
                    FirstResponseMetAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ResolutionMetAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    FirstResponseWarned = table.Column<bool>(type: "boolean", nullable: false),
                    FirstResponseBreached = table.Column<bool>(type: "boolean", nullable: false),
                    ResolutionWarned = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectSequences_ProjectId",
                table: "ProjectSequences",
                column: "ProjectId");
