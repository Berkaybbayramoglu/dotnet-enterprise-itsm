=
8javascript.telemetry.generated-sources.tagged-file-count0#
python.analysis.threads.actual6
text.civendor_semaphore0"
jre_provisioning_disabledfalseS
Ndotnetenterprise.s4net.build.target_framework_moniker._netcoreapp_version_v8_03*
%python.packages.build_system.uv_build06
)dotnetenterprise.s4net.serverInfo.product	SQ_ServerF
Adotnetenterprise.s4net.build.nuget_project_style.packagereference3%
 text.analyzed_hidden_files_count0F
=javascript.telemetry.typescript.compiler-options.alwaysStrictfalse#
javascript.runtime.version24.11H
?javascript.telemetry.typescript.compiler-options.noImplicitThisfalse2
-javascript.telemetry.import.builtin.node.http3&
 javascript.runtime.major-version24%
 python.packages.build_system.pdm0/
$dotnetenterprise.s4net.begin.runtimenetcore
text.civendor_travisci0/
*python.files.main.misclassified_path_based0%
text.sensor_time_ms_community1176
...
python.lines.main894)
$python.test_file_heuristic.triggered0"
...
/dotnetenterprise.s4net.build.deterministic.true3!
iac.pluginVersion2.13.0.219334
/javascript.telemetry.module-type.esm-file-count0
python.dependenciesB
4javascript.telemetry.typescript.compiler-options.lib
dom,esnextV
Mjavascript.telemetry.typescript.compiler-options.strictPropertyInitializationfalseM
...
(text.secrets.disable_test_file_detection0/
*python.lines.main.misclassified_path_based0(
#python.packages.build_system.poetry0J
Ajavascript.telemetry.typescript.compiler-options.strictNullChecksfalse)
$python.types.names.unresolved_import00
+python.packages.resolved_via_legacy_init_py16
1python.lines.main.misclassified_import_based_only01
,python.lines.main.misclassified_import_based0?
:javascript.telemetry.typescript.program-creation.succeeded1(
#csharp.cs.language_version.csharp123
text.civendor_gitlab0+
&python.packages.duplicate_without_init0
python.nosonar.comments;
2dotnetenterprise.s4net.endstep.coverage_conversionfalse
python.analysis.uses_cache0:
)dotnetenterprise.s4net.serverInfo.version26.8.0.1268085
/javascript.telemetry.module-type.cjs-file-count578
3javascript.telemetry.generated-sources.family-count0$
python.files.scanned_with_cache0!
python.packages.without_init16
1python.files.main.misclassified_import_based_only0=
8dotnetenterprise.s4net.build.netcore_sdk_version.8_0_1303
python.files.count129
-dotnetenterprise.s4net.scannerEngine.downloadCacheHit
python.version.set00
+javascript.telemetry.import.builtin.node.fs6!
text.civendor_azurepipelines06
.javascript.telemetry.typescript.native-previewtrueF
>javascript.telemetry.typescript.compiler-options.noImplicitAnytrueB
=dotnetenterprise.s4net.build.override_warnings_as_errors.true3&
!python.packages.build_system.flit0 
text.civendor_dockercompose0
python.lines.total894:
5python.packages.namespace_packages_in_regular_package09
2dotnetenterprise.s4net.params.sonar_verbose.sourceCLIF
(javascript.telemetry.typescript.versions6.0.3,7.0.0-dev.20260707.20
+javascript.telemetry.import.builtin.node.vm1!
python.types.symbols.unique60M
Djavascript.telemetry.typescript.compiler-options.strictBindCallApplyfalse
python.files.main.total12;
...
*python.packages.resolved_via_sonar_sources0"
python.imports.format_version10
+python.packages.resolved_via_pyproject_toml03
(dotnetenterprise.s4net.jre.bootstrappingEnabled,
'python.packages.build_system.setuptools0
python.nosonar.rule_idsT
Kjavascript.telemetry.typescript.compiler-options.useUnknownInCatchVariablesfalse&
!javascript.telemetry.import.acorn3+
&python.packages.build_system.hatchling04
/python.lines.main.misclassified_path_based_only0 
text.analyzed_files_count244>
9dotnetenterprise.s4net.build.using_microsoft_net_sdk.true3
